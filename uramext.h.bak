...
extern char kwzDefekt;		// Kaltwasser-Zähler defekt
...
extern char ZeitLoesch; 											// Zeiten löschen (auch bei KS66=1)
...
extern UINT TH2MittelZaehler;			// Minuten-Zähler Mittlere TH2 diesen Monat (max. 44640)
...
extern UINT TN2MittelZaehler;			// Minuten-Zähler Mittlere TH2 diesen Monat (max. 44640)
...
//extern mwsp SSM_Ext1;						// HAST 1: Sammelstörung  über Bus	(R101-Copy)
//extern mwsp ANF_Ext1;						// HAST 1: Sollwert-Anforderung  über Bus	(R101-Copy)
//extern mwsp SSM_Ext2;						// HAST 2: Sammelstörung  über Bus	(R101-Copy)
//extern mwsp ANF_Ext2;						// HAST 2: Sollwert-Anforderung  über Bus	(R101-Copy)

// Sollwert-Anforderung von Daten-Manager	***AnFre 19.04.2012
extern mwsp DM_ANF_Ext1;					// HKV 1: Sollwert-Anforderung  über S1/S2
extern mwsp DM_ANF_Ext2;					// HKV 2: Sollwert-Anforderung  über S1/S2
extern mwsp DM_SSM_Ext1;					// HKV 	: Sammelstörung 				 über S1/S2
extern mwsp DM_SSM_Ext2;					// WPU	: Sammelstörung 				 über S1/S2
...
extern mwsp	WZxTR[];					//  WZx: Rücklauf zur Anzeige
extern int		WZxTRKorr[];		//	WZx: Rücklauf
