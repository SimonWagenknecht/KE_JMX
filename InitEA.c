...
// "........","........"
	...
	{"STW HK1 ","STWHK2  ","STWHK3  ","STWHK4  "},		// 3
	...
	{"BM PU-NT","BMPUNT2 ","BMPUNT3 ","BMPUNT4 "},		// 2E
	{"        "},																			// 2F
	{"BM PU-SO"},																			// 30	
//	{"BM PU-NT","BM PUNT2"},													// 31	
	{"BM PU-KE","BM PUKE2"},													// 31	
	{"BM PU-PU"},																			// 32	
...
// "........","........"
	{"FREI    "},
	{"ZIN3    ","ZIN4    ","ZIN5    ","ZIN6    ","ZIN7    ","WZ1-HEIZ","WZ2-SOL ","WZ3-TWE "},	// 1 (R36)
	{"EXT-Z   ","KWZ-TWE ","ZIN13   ","ZIN14   ","ZIN15   ","ZIN16   "},												// 2 (R37_1)
...
// "........","........"
	...
	{"SOL-PUM ","HK SOLL ","HK-VENT ","WW-VENT ","AA_UNI5 ","AA_UNI6 ","AA_UNI7 ","AA_UNI8 "},		// A	
...
//josch					
			...
			case 0x2E:													// BM Netz-Pumpe sekundär
					dipadr = &BMPUNT[num];
					break;
			...
			case 0x31:													// BM Kessel/Zubringer-Pumpe
					dipadr = &BMPUKE[num];
					break;
			
			case 0x32:													// BM Puffer-Pumpe
					dipadr = &BMPUPUF[num];
					break;
