...
// ***AnFre
#define PR1					0							// Index für Profil 1
#define PR2					1							// Index für Profil 2
...
#define ANFORD			0		//***AnFre ACHTUNG NICHT BENUTZEN, da im R36CPool seit 23.02.2010 geändert !!!!!!!!!!!!!!!!
...
//--------------------------------------------------------------------------
  ...
  #define BUS_PU_MAX   5  // Pumpenanzahl gemäß Projektspezifkationen setzen!
#else	
  #define BUS_PU_MAX   0
#endif
...
#define PULZ_HK1		1							// Pumpenlaufzeit berechnen und anzeigen ( parli, steuer.c, 
...
#define PU_BUS_HK1	3							// ungleich 0: Pumpe busgesteuert, Wert = Parameter-Index bei Solar nicht verändern!!!
...
#define PULZ_HK2		0							// Pumpenlaufzeit berechnen und anzeigen ( parli, steuer.c, 
#define FBH_HK2			1							// Fußbodenheizung mit Estrich-Programm 
#define LEIBEGR_HK2	0							// Leistungsbegrenzung (Leistungsberechnung von ext.Wärmezähler)
#define PU_BUS_HK2	0							// ungleich 0: Pumpe busgesteuert, Wert = Parameter-Index bei Solar nicht verändern!!!	
...
#define PULZ_HK3		0							// Pumpenlaufzeit berechnen und anzeigen ( parli, steuer.c, 
...
#define PULZ_HK4		0							// Pumpenlaufzeit berechnen und anzeigen ( parli, steuer.c, 
...
// --------------Solare Heizkreis-Regelungen ***AnFre -----------------------------------
#define HKSoLANZ			1							// projektierte Anzahl von Solar-Heizkreisen
#define HKSoLMAX			1							// maximale Anzahl (wegen Speicherzuweisung mindestens 1)

// --------------- Warmwasser-Regelungen ----------------------------------
#define WWANZ				1							// projektierte Anzahl von Regelkreisen
#define WWMAX				1							// maximale Anzahl (wegen Speicherzuweisung mindestens 1)
// ***AnFre
#define PRANZ				1							// projektierte Anzahl der Profile
#define PRMAX				1							// maximale Anzahl der Profile

// Einstellung für SteuerWw
#define PUWL_MODE		0						// Einschalten der Ladepumpe im Ladebetrieb:
																	//  	0 = sofort
...
#define REGEL_WW1		1							// 1 = mit Warmwasserregelung, benutzt auch in RegelNt.c !!!
#define DREIP_WW1		0							// 1 = DreipunktAusgabe,  0=Analogausgabe

#define LPU_WW1			0							// 1 = Ladepumpe vorhanden ( SteuerWw )
...
#define ZPU_WW1			1							// 1 = Zirkulationspumpe vorhanden																	
#define ZPUBM_WW1		1							// 1 = Betriebsmeldung Zirk.pumpe vorhanden
...
#define TPU_WW1			1							// 1 = Tauscherpumpe vorhanden
#define TPUAL_WW1		0							// 1 = Tauscherpumpen-Alarm vorhanden
#define TPUBM_WW1		1							// 1 = Betriebsmeldung Tauscherpumpe vorhanden
...
#define STW_WW1			1							// STW-ALARM

// Pumpenbus
#define PU_BUS_TPU_WW1 	4					// ungleich 0: Pumpe busgesteuert, Wert = Parameter-Index
#define PU_BUS_LPU_WW1 	0					// ungleich 0: Pumpe busgesteuert, Wert = Parameter-Index
#define PU_BUS_ZPU_WW1 	5					// ungleich 0: Pumpe busgesteuert, Wert = Parameter-Index

// --------------- Kessel-Regelungen --------------------------------------
#define KEANZ				1							// projektierte Anzahl von Regelkreisen
...
#define STUFIG_KE1	0							// Kesselsteuerung 1-stufig=1  2-stufig=2  modulierend=0
#define DREIP_KE1		0							// Modulation. 1=DreipunktAusgabe 0=Analogausgabe
#define DREIP_RKE1	0							// Rücklauf-Begrenzung: 1=DreipunktAusgabe 0=Analogausgabe
#define KESART_KE1	0							// 0 = Normal  1 = Brennwertkessel
#define TV_KE1			1							// 1 = Kesselvorlauftemperatur anzeigen
...
#define KEAL_KE1		1							// 1 = Kesselalarm (Si-Kette) anzeigen
#define BRAL_KE1		0							// 1 = Störung Brenner anzeigen
#define PUAL_KE1		0							// 1 = Störung Kesselpumpe anzeigen
#define NACHSP_KE1	1							// 1 = Störung Nachspeisung anzeigen
#define SSTM_KE1		0							// 1 = SammelStörung anzeigen
...
#define ANH_RL_KE1	0							// 1 = Kesselrücklauf-Anhebung
// ***AnFre
#define PUBM_KE1		0							// 1 = Betriebsmeldung Zubringer-Pumpe

#define PU_BUS_KE1  0							// ungleich 0: Pumpe busgesteuert, Wert = Parameter-Index				//***AnFre 06.06.2012 fehlt noch !!!

// Einstellung für Parli: ke2[]
#define STUFIG_KE2	0							// Kesselsteuerung 1-stufig=1  2-stufig=2  modulierend=0
#define DREIP_KE2		0							// Modulation. 1=DreipunktAusgabe 0=Analogausgabe
#define DREIP_RKE2	0							// Rücklauf-Begrenzung: 1=DreipunktAusgabe 0=Analogausgabe
#define KESART_KE2	0							// 0 = Normal  1 = Brennwertkessel
...
#define TRG_KE2			0							// 1 = gemeinsame Rücklauftemperatur anzeigen 
...
#define SSTM_KE2		0							// 1 = SammelStörung anzeigen
...
#define ANH_RL_KE2	0							// 1 = Kesselrücklauf-Anhebung
...
// --------------- Solar-Regelungen ***AnFre ---------------------------------------
#define SOANZ			1							// projektierte Anzahl von Solar-Regelkreisen
#define SOMAX			1							// maximale Anzahl (wegen Speicherzuweisung mindestens 1)
#define PUBM_SO1	0							// Betriebsmeldung Solar-Pumpe
//***AnFre 12.12.2012  !!!
#define PU_BUS_SOL  1							// Solar-Pumpe 	busgesteuert, Wert = Parameter-Index	bei Solar nicht verändern!!!
#define PU_BUS_PUF  2							// Puffer-Pumpe busgesteuert, Wert = Parameter-Index  bei Solar nicht verändern!!!
...
#define ZE6					0	
#define ZE7					0
#define ZE8					1	//	"				"		WZ1: Heizung	
#define ZE9					1	//  "				"		WZ2: Solar
#define ZE10				1	//  "				"		WZ3: TWW
...
#define ZE10WM			1 						// 1/0 Wärmemenge berechnen / nicht berechnen
...
#define LEIST_BER_ZE10			1					// Berechnung der maximalen Durchschnittsleistung (int./ext.WMZ)
...
#define R37_MODULE	2							// Anzahl der Module R37
#define R37_MODMAX	2							// wegen Speicherzuweisung mindestens 1

// Zähleingänge R37_1 Einstellung für Parli: x1ze[0] bis x1ze[5]
//																und für Datenübertragung (InoutR.c) !
#define ZE11				1		// Gas-Zähler
#define ZE12				1		//  Vol.geber 	KWZ: KaltWasser -Zähler	
#define ZE13				0
#define ZE14				0
#define ZE15				0
#define ZE16				0
