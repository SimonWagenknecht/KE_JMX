// Diese Datei wurde automatisch am : 01.11.2017 um 15:01:37 generiert und entspricht der Systemversion nach 04.09.2012 13:47:53!!!
...
const Pgrup so1[] = { 
	...
	{"*06:"," PUFFERSP TSPo-P"," C    ", P&TS6_[0],						 ANA_FORMP, 1, P&vis,		V1, 0, 0},
...
const Pgrup anl[] = { 
	...
	{"*56;"," VENTILST.  RV H"," %     ", P&RVENT[HK1],						 AOUT_FORMP, 1, P&hid1,	V0, 0, 0},
...
const Parli Pgruppe[] = { 
	...
	{"WTW:", ze7, sizeof(ze7) / PGLENG, P&ze_vis[7]},
