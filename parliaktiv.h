// Diese Datei wurde automatisch am : 06.06.2018 um 10:10:50 generiert und entspricht der Systemversion nach 19.07.2017 10:21:03!!!
...
const Pgrup so1[] = { 
	...
	{"*->;"," DREHZAHL IST   "," 1/min ", P&modWiloPu[PU_BUS_PUF - 1].wiloInReg.mwspSpeed.messw, 	US_INT,  0, P&wilo2,V0, 0, 0},
	{"*->;"," DIFFERENZDRUCK "," mWS   ", P&modWiloPu[PU_BUS_PUF - 1].wiloInReg.mwspActualDifferentialPressure.messw, 	US_INT,	 1, P&wilo2,V0, 0, 0},
	{"*->;"," FOERDERSTROM   "," m/h  ", P&modWiloPu[PU_BUS_PUF - 1].wiloInReg.mwspFlowRate.messw, 	US_INT,	 1, P&wilo2,V0, 0, 0},
