...
----------------------------------------------------------------------
	...
	Klasse:	Pt1000-Eingänge											reservierte Speicherplätze
					...
					0A = Temp.								TWWV			2
					0B = Kesselvorlauf				TVKE			2
					0C = Kesselrücklauf				TRKE			2
...
##### ulsch
					...
					...
***AnFre Josch		Warmwasser Station SEZ40-200
					20 = Regeltemp. nach PWÜ	TW1				1
					21 = Vorlauf Gebäude			TW2				1
					22 = Speichertemp. 				TW3				1
***AnFre Solar Station SEZ40-200
					23 = VL Kollektor					TS1				1
					24 = VL Solar-PWÜ TWW			TS2				1
					25 = VL Solar-PWÜ Heizung	TS3				1
					26 = VL Solar-PWÜ Puffer	TS4				1
					27 = RL Kollektor					TS5				1
					28 = Puffer oben					TS6				1
					29 = Puffer unten					TS7				1
					2A = Speichertemp. 				TW4				1
					2B = Rücklauf Sek.(Netztr)TRSEK			2
...
#####ulsch
					...
					2D = Digitaleingang				PUALNT		4		Störmeldung Netz-Pumpe
					2E = Digitaleingang				BMPUNT		4		Betriebsmeldung Netz-Pumpe
					...	
***AnFre
					30 = Digitaleingang				BMPUSOL		1		Betriebsmeldung Solarkreis-Pumpe
					31 = Digitaleingang				BMPUKE		1		Betriebsmeldung Kessel/Zubringer-Pumpe
					32 = Digitaleingang				BMPUPUF		2		Betriebsmeldung Pufferkreis-Pumpe
	...
	Klasse:	Analogausgänge											reservierte Speicherplätze
					...
					...
// ***AnFre Josch
					18 =											MVSOLWW		2 MotorVentil Solar-Warmwasser
					19 = 											MVKALTW		2	MotorVentil KaltWasser
					...
...
//***AnFre Warmwasser Station SEZ40-200
#define TW1				0x1201
#define TW2				0x1211
#define TW3				0x1221
//***AnFre Solar Station SEZ40-200
...
// ***AnFre
#define	BMPUSOL1	0x3301					// Betriebsmeldung Solarkreis-Pumpe
#define	BMPUSOL2	0x3302					// Betriebsmeldung Solarkreis-Pumpe

#define	BMPUKE1		0x3311					// Betriebsmeldung Kessel/zubringer-Pumpe
#define	BMPUKE2		0x3312

#define	BMPUPUF1	0x3321					// Betriebsmeldung Pufferkreis-Pumpe
#define	BMPUPUF2	0x3322					// Betriebsmeldung Pufferkreis-Pumpe
...
// ***AnFre
#define	MVSOLWW1	0x5181					// MotorVentil Solar-Warmwasser				
#define	MVSOLWW2	0x5182

#define	MVKALTW1	0x5191					// MotorVentil KaltWasser				
#define	MVKALTW2	0x5192
...
//	***AnFre Josch
#define PUSOL1EA	0x6281	//	***AnFre
#define PUSOL2EA	0x6282

#define PUPUF1EA	0x6291	// 	***AnFre
#define PUPUF2EA	0x6292

#define MVKOL1EA	0x62A1 // ***AnFre
#define MVKOL2EA	0x62A2 

 #define MVPUF1EA	0x62B1 // ***AnFre 
 #define MVPUF2EA	0x62B2 

#define MVWL1EA		0x62C1 // ***AnFre
#define MVWL2EA		0x62C2

// #define UVHK1EA		0x62D1 // ***AnFre 31.01.2008 	 nicht mehr vorh.21.01.2010
// #define UVHK2EA		0x62D2 

#define UVWW1EA		0x62E1 // ***AnFre 31.01.2008
#define UVWW2EA		0x62E2 
