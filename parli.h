...
const Pgrup anl[] = {
	...
	{"*->."," PUFFER WARM TS6"," C    ", P&TS6_[0],						 ANA_FORMP, 1, P&hid4,		V1, 0, 0},
  ...
  {"*->."," ANZEIGE RESERVE","       ", P&anz_dummy,						US_CHAR,	0, P&hid4,		V1, 0, 0},
	...
	{" 13;"," DAEMPFUNGSZEIT "," min   ", P&Ta1mzk,									 US_CHAR, 0, P&hid1,	V0, 0, 0},

	{" ->."," TA-ERSATZ JAN  "," C    ", P&TaErsatz[0],							 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," TA-ERSATZ FEB  "," C    ", P&TaErsatz[1],							 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," TA-ERSATZ MRZ  "," C    ", P&TaErsatz[2],							 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," TA-ERSATZ APR  "," C    ", P&TaErsatz[3],							 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," TA-ERSATZ MAI  "," C    ", P&TaErsatz[4],							 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," TA-ERSATZ JUN  "," C    ", P&TaErsatz[5],							 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," TA-ERSATZ JUL  "," C    ", P&TaErsatz[6],							 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," TA-ERSATZ AUG  "," C    ", P&TaErsatz[7],							 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," TA-ERSATZ SEP  "," C    ", P&TaErsatz[8],							 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," TA-ERSATZ OKT  "," C    ", P&TaErsatz[9],							 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," TA-ERSATZ NOV  "," C    ", P&TaErsatz[10],							 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," TA-ERSATZ DEZ  "," C    ", P&TaErsatz[11],							 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," TA-ERSATZ VERZ."," h     ", P&TaErsatzVerz,						 US_CHAR, 0, P&hid2,	V0, 0, 0},
	...
	{" 15;"," MITTLUNGS-ZEIT "," h     ", P&Ta1mhzk,								 US_CHAR, 0, P&hid1,		V0, 0, 0},
	...
	#if TAA_ANZ == 1
	{"*25;"," Ta AUSGABE     "," Volt  ", P&TAA[0],								AOUT_FORMP, 2, P&hid1, 	V0, 0, 0},
	{" ->."," Ausgabe Ta   0V"," C    ", P&TaaSkalMin,								 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," Ausgabe Ta  10V"," C    ", P&TaaSkalMax,								 S_INT, 1, P&hid2,	V0, 0, 0},
	#endif

	#if TAE_ANZ == 1
	{"*26;"," Ta 0..10V-EING."," C    ", P&ta_ae,									ANA_FORM, 1, P&hid1,	V0, 0, 0},
	{" ->."," Eingabe Ta   0V"," C    ", P&TaeSkalMin,								 S_INT, 1, P&hid2,	V0, 0, 0},
	{" ->."," Eingabe Ta  10V"," C    ", P&TaeSkalMax,								 S_INT, 1, P&hid2,	V0, 0, 0},
	#endif
...
// senden an WPU
	...
	{"*56;"," VENTILST.  RV H"," %     ", P&RVENT[HK1],						 AOUT_FORMP, 1, P&hid1,	V0, 0, 0},	// nach WP
		#endif
...
// AnFre 17.11.2011 02.10.2012 geändert !!!
	...
	{"*95:"," SSM EXT.2 WPU ?","       ", P&ext2SammelSM,				 JANEIN_FORM, 0, P&vis,		A1, EINZEL, 0},
	{"*96:"," SSM EXT.3 KES ?","       ", P&ext3SammelSM,				 JANEIN_FORM, 0, P&vis,		A1, EINZEL, 0},
	{"*97:"," EXTERNE SSM ?  ","       ", P&SAMAL[ANL], 		 	 JANEIN_FORMIP, 0, P&vis,		A1, EINZEL, 0},
 	{"_->."," SSM-Bezeichnung","       ", (char*)(EXTALARMTEXT_ADR),	EEP_ASCII_FORM, 15, P&hid2,	V0, 0, 0},

//	#if ANFORD > 0
//	{"*97:"," ANFORDERUNG MAX"," C    ", P&maxAnford,				 				 S_INT, 1, P&vis, 	V1, 0, 0},
//	#endif
...
//	{"*02:"," RL-KESSEL TRKES"," C    ", P&TRKE[KE1],				ANA_FORMP, 0x81, P&kom,		E1, FUEHLER, 0},
	...
	{" 12;"," ANHEBUNG  [HK1]"," K     ", P&kes[KE1].Tvpa,					S_INT, 	1, P&hid1,		V1, 0, 0},
	{" 13;"," ANHEBUNG  [TWE]"," K     ", P&kes[KE1].TvPaWw,				S_INT, 	1, P&hid1,		V1, 0, 0},
...
// 24.10.2012 Kessel-Freigabe entsprechend der Ventilstellung der Wärmepumpe: DM_WPU_Ventil
	...
	{" ->."," RV H ZU        "," min   ", P&hksSoL[HK1].RVzu,			 	 US_CHAR, 0, P&hid2,	V0, 0, 0},
	{" ->."," RV H Zu   Cnt  "," s     ", P&hkdSoL[HK1].zRVzu,			 	US_INT, 0, P&hid2,	V0, 0, 0},
	{" ->."," RV H AUF       "," min   ", P&hksSoL[HK1].RVauf,			 US_CHAR, 0, P&hid2,	V0, 0, 0},
	{" ->."," RV H Auf  Cnt  "," s     ", P&hkdSoL[HK1].zRVauf,			 	US_INT, 0, P&hid2,	V0, 0, 0},

	{"*73:"," TWE-BEDARF ?   ","       ", P&wwd[WW1].twwBed,		 JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	{" ->."," RV TWE ZU      "," min   ", P&wws[WW1].RVzu,				 	 US_CHAR, 0, P&hid2,	V0, 0, 0},
	{" ->."," RV TWE Zu   Cnt"," s     ", P&wwd[WW1].zRVzu,					 	US_INT, 0, P&hid2,	V0, 0, 0},
	{" ->."," RV TWE AUF     "," min   ", P&wws[WW1].RVauf,				 	 US_CHAR, 0, P&hid2,	V0, 0, 0},
	{" ->."," RV TWE Auf  Cnt"," s     ", P&wwd[WW1].zRVauf,				 	US_INT, 0, P&hid2,	V0, 0, 0},
...
#if WWANZ > 0
const Pgrup ww1[] = {
	{"***:"," WARMWASSER     ","       ", P&Wwmod,						ASCII_FORM, 0, P&vis,		V0, 0, 0},

	{"*01:"," REGELTEMP.  TW1"," C    ", P&TW1_[0],						 ANA_FORMP, 1, P&vis,		V1, 0, 0},
	{"*01:"," REGELTEMP.  TW1"," C    ", P&TW1_[0],					ANA_FORMP, 0x81, P&kom,		E1, FUEHLER, 0},
	{"*02:"," SPEICHER OB.TW2"," C    ", P&TW2_[0],						 ANA_FORMP, 1, P&vis,		V1, 0, 0},
	{"*02:"," SPEICHER OB.TW2","       ", P&TW2_[0],					ANA_FORMP, 0x80, P&kom,		E1, FUEHLER, 0},
	{"*03:"," SPEICHER MI.TW3"," C    ", P&TW3_[0],						 ANA_FORMP, 1, P&vis,		V1, 0, 0},
	{"*03:"," SPEICHER MI.TW3","       ", P&TW3_[0],					ANA_FORMP, 0x80, P&kom,		E1, FUEHLER, 0},
	{"*04:"," SPEICHER UN.TW4"," C    ", P&TW4_[0],						 ANA_FORMP, 1, P&vis,		V1, 0, 0},
	{"*04:"," SPEICHER UN.TW4","       ", P&TW4_[0],					ANA_FORMP, 0x80, P&kom,		E1, FUEHLER, 0},
	{"*05:"," ZIRK-RUECKL TW5"," C    ", P&TWWZ[WW1],					 ANA_FORMP, 1, P&vis,		V1, 0, 0},
	{"*05:"," ZIRK-RUECKL TW5"," C    ", P&TWWZ[WW1],				ANA_FORMP, 0x81, P&kom,		E1, FUEHLER, 0},
	{"*06:"," TWE-RUECKL. TW6"," C    ", P&TWWP[WW1],					 ANA_FORMP, 1, P&vis,		V1, 0, 0},
	{"*06:"," TWE-RUECKL. TW6"," C    ", P&TWWP[WW1],				ANA_FORMP, 0x81, P&kom,		E1, FUEHLER, 0},

	
	{" 10;"," WW-SOLLTEMP.   "," C    ", P&wws[WW1].Twwsol,				US_INT, 1, P&hid1,		V1, 0, 0},
	{"*->:"," AKTIVE SOLLTEMP"," C    ", P&prd[PR1].aktTwwsol,			US_INT, 1, P&vis,			V1, 0, 0}, //siehe Profile
	{" 11;"," dT LADETEMP.   "," K     ", P&wws[WW1].DTTwwlad,			 S_INT, 1, P&hid1,		V1, 0, 0},
	{"*->:"," AKTIVE LADETEMP"," C    ", P&prd[PR1].aktTwwlad,			US_INT, 1, P&vis,			V0,	0, 0},
	{" 12;"," dT VORRANGTEMP."," K     ", P&wws[WW1].DTTwwVor,			 S_INT, 1, P&hid1,		V1, 0, 0},
	{"*->:"," AKTIVE VORR.TEM"," C    ", P&prd[PR1].aktTwwVor,			US_INT, 1, P&vis,			V0,	0, 0},
	{" 13;"," REGELHYSTERESE "," K     ", P&wws[WW1].RegHyst,				US_INT, 1, P&hid1,		V0, 0, 0},
	{" 14;"," dT REGEL-SOLAR "," K     ", P&wws[WW1].DTRegSol,			 S_INT, 1, P&hid1,		V1, 0, 0},
	{"*->."," Berech-Sollwert"," C    ", P&wwd[WW1].twwsb,				  US_INT, 1, P&hid2,		V0, 0, 0},
	{" 16;"," dT UNTERWERT-T."," K     ", P&wws[WW1].DTTwwUnter,		 S_INT, 1, P&hid1,		V1, 0, 0},
	{"*->:"," AKTIVE UNTERW-T"," C    ", P&prd[PR1].aktTwwUnter,		US_INT, 1, P&vis,			V0, 0, 0},
	{" 17;"," dT LADEBEG. KES"," K     ", P&wws[WW1].DTTwwlbeg,			 S_INT, 1, P&hid1,		V1, 0, 0},
	{"*->:"," AKTIVE LADEB.KE"," C    ", P&prd[PR1].aktTwwlbeg,		US_INT, 1, P&vis,			V0, 0, 0},
	{" 18;"," dT LADEBEG.SOLA"," K     ", P&wws[WW1].DTTwwlbegS,		 S_INT, 1, P&hid1,		V1, 0, 0},
	{"*->:"," AKTIVE LADEB.SO"," C    ", P&prd[PR1].aktTwwlbegS,		US_INT, 1, P&vis,			V0, 0, 0},
	{" 19;"," dT LADEENDE    "," K     ", P&wws[WW1].DTTwwlend,			 S_INT, 1, P&hid1,		V1, 0, 0},
	{"*->:"," AKTIVE LADEENDE"," C    ", P&prd[PR1].aktTwwlend,		US_INT, 1, P&vis,			V0, 0, 0},

	{" 20;"," PROFIL-ZEIT 1  "," h:min ", P&prs[PR1].profil[0].Zeit,		ZEIT_FORM, 0, P&hid1,	V1, 0, 0},
	...
	{" 35;"," WW-ABSENKTAGE  "," Mo=1..", P&wws[WW1].AbsTag,	 GWOTAG2_FORM, 0, P&hid1,	V1, 0, 0},
	{" 36;"," ABSENK-SOLLTEMP"," C    ", P&wws[WW1].TwwAbs,				 US_INT, 1, P&hid1,	V1, 0, 0},
	{"*->."," Absenkdifferenz"," K     ", P&prd[PR1].deltaTwwAbs,			S_INT, 1, P&hid2,	V0,	0, 0},

	{" 40;"," LEGIONELLENTOD "," JA=1  ", P&wws[WW1].Legjn,				 US_CHAR, 0, P&hid1,	V1, 0, 0},
	{" 41;"," LEGION.-TAGE   "," Mo=1..", P&wws[WW1].Legtag,	GWOTAG2_FORM, 0, P&hid1,	V1, 0, 0},
	{" 42;"," LEGION.-ZEIT   "," h:min ", P&wws[WW1].Legzeit,		 ZEIT_FORM, 0, P&hid1,	V1, 0, 0},
	{" 43;"," LEGION.-DAUER  "," min   ", P&wws[WW1].Legdau,			 US_CHAR, 0, P&hid1,	V1, 0, 0},
	{" 44;"," LEGION.-SPERREN"," h     ", P&wws[WW1].LegSperr,		 US_CHAR, 0, P&hid1,	V1, 0, 0},
	{" ->."," Sperren     Cnt"," *30 s ", P&sod[SO1].zLegSperr,			US_INT, 0, P&hid2,	V0, 0, 0},
	{" 45;"," LEGION.-TEMP.  "," C    ", P&wws[WW1].Twwleg,				US_INT, 1, P&hid1,	V1, 0, 0},

	{" 50;"," PU TWE SOLLWERT"," %     ", P&wws[WW1].BusTauPuSoll,	US_INT, 1, P&wilo4,	V1, 0, 0},
	{" 51;"," PU TWE R-ART SO"," 0-3   ", P&BusPuPara[PU_BUS_TPU_WW1 - 1].Regelart, US_CHAR, 0, P&wilo4,	V0, 0, 0},
	{" 55;"," PU ZIR-SOLL NOR"," %     ", P&wws[WW1].BusZirPuSoll,	US_INT, 1, P&wilo5,	V1, 0, 0},
	{" 56;"," PU ZIR-SOLL LAD"," %     ", P&wws[WW1].BusZirPuSollLad,US_INT,1, P&wilo5,	V1, 0, 0},
	{" 57;"," PU ZIR R-ART SO"," 0-3   ", P&BusPuPara[PU_BUS_ZPU_WW1 - 1].Regelart, US_CHAR, 0, P&wilo5,	V0, 0, 0},

	{" 60;"," VORRANG VOR HK1"," JA=1  ", P&hks[HK1].Wwvh,			 	 US_CHAR, 0, P&hid1,	V1, 0, 0},
	{" 61;"," HK1 ABSENKUNG  "," K     ", P&wws[WW1].TwwHkAbsenk,		US_INT, 1, P&hid1,	V1, 0, 0},
	{" 62;"," VORRANGZEIT MAX"," min   ", P&wws[WW1].Vorrad,		 	 US_CHAR, 0, P&hid1,	V1, 0, 0},
	{" 63;"," ZPU-ABSCH.ZEIT "," h:min ", P&wws[WW1].Puwzab,		 ZEIT_FORM, 0, P&hid1,	V1, 0, 0},
	{" 64;"," ZPU-ABSCH.DAUER"," h     ", P&wws[WW1].Puwzdau,			 US_CHAR, 0, P&hid1,	V1, 0, 0},
	{" ->."," Z-Pu absch. Cnt"," *30 s ", P&wwd[WW1].zpuwz,			 		US_INT, 0, P&hid2,	V0, 0, 0},
	{" 66;"," L-VENT NACHLAUF"," min   ", P&wws[WW1].Puwlna,			 US_CHAR, 0, P&hid1,	V0, 0, 0},
	{" ->."," LV-Nachlauf Cnt"," *30 s ", P&wwd[WW1].zpuwlna,			  US_INT, 0, P&hid2,	V0, 0, 0},
	{" 68."," TDiff.Alarm Ein"," K     ", P&wws[WW1].TabwMax,			 US_CHAR, 1, P&hid2,	V0, 0, 0},
	{" 69."," ZVerz.Alarm Ein"," min   ", P&wws[WW1].TabwZeit,		 US_CHAR, 0, P&hid2,	V0, 0, 0},

	{"*70:"," LADEBETR. KES ?","       ", P&wwd[WW1].wwlad,		 JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	{"*71:"," LADEBETR. SOL ?","       ", P&wwd[WW1].wwLadS,	 JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	{"*72:"," SOL.VORWAERM.? ","       ", P&wwd[WW1].solWwVW,  JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	{"*73:"," SOLARE LADUNG ?","       ", P&wwd[WW1].solWwLdg, JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	{"*74:"," SOLARE ZIRK. ? ","       ", P&wwd[WW1].solWwZir, JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	{"*75:"," DV TWL     AUF?","       ", P&MVWLEA[WW1],		 JANEIN_FORMOP, 0, P&vis,		V1, 0, 0},
	{"*76:"," WW-VORRANG ?   ","       ", P&wwd[WW1].wwvor,		 JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	{" ->."," Vorrang     Cnt"," *30 s ", P&wwd[WW1].zvorrad,		 	  US_INT, 0, P&hid2,	V0, 0, 0},
	{"*77:"," KONV.-LEGION. ?","       ", P&wwd[WW1].konvLegio,JANEIN_FORM, 0, P&vis,		V1, 0, 0},	//!!!AnFre
	{" ->."," K-Leg Dauer Cnt"," *30 s ", P&wwd[WW1].zleg,			 		US_INT, 0, P&hid2,	V0, 0, 0},		// ***AnFre
	{"*78:"," SOLAR-LEGION. ?","       ", P&wwd[WW1].solarLegio,JANEIN_FORM,0, P&vis,		V1, 0, 0},	//!!!AnFre
	{" ->."," S-Leg Dauer Cnt"," *30 s ", P&sod[SO1].zSLeg,			 		US_INT, 0, P&hid2,	V0, 0, 0},

	{"*80:"," PU TWE    EIN ?","       ", P&wwd[WW1].puwtEinAnz, JANEIN_FORM, 0, P&vis,	V1, 0, 0},
	{"*->."," PU TWE-Laufzeit"," h     ", P&wwd[WW1].puwtLzAnz,			 US_LONG, 0, P&hid2,V1, 0, 0},
	{" ->;"," PU TWE Nachlauf"," min   ", P&wws[WW1].Puwtna,			 US_CHAR, 0, P&hid1,	V0, 0, 0},
	{" ->."," PU TWE-Nachl.Cn"," *30 s ", P&wwd[WW1].zpuwtna,			  US_INT, 0, P&hid2,	V0, 0, 0},
	{"*->:"," BM PU TWE  EIN?","       ", P&wwd[WW1].puwtBmAnz,  JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	...
	{"*->:"," BM PU ZIR  EIN?","       ", P&wwd[WW1].puwzBmAnz,  JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	...
	{"*87:"," SM PU ZIR    ? ","       ", P&wwd[WW1].puwzSmAnz,JANEIN_FORM, 0, P&vis,		E1, STANDARD, 0},
	#endif
	#if TPUBM_WW1 == 1	// Betriebsmeldung Tauscherpumpe vorhanden
	{"*88:"," SM PU TWE     ?","       ", P&wwd[WW1].puwtSmAnz,JANEIN_FORM, 0, P&vis,		E1, STANDARD, 0},
	#endif
	{"*89:"," HANDBETRIEB   ?","       ", P&wws[WW1].Haut,		 JANEIN_FORM, 0, P&vis,		E1, EREIGNIS, 0},

	{" 90;"," P-VERSTAERKUNG "," %/K   ", P&wws[WW1].Kp,						US_INT, 2, P&hid1,	V0, 0, 0},
	{" 91;"," D-VERSTAERKUNG ","       ", P&wws[WW1].Kd,						US_INT, 2, P&hid1,	V0, 0, 0},
	{" 92;"," TASTZEIT       "," s     ", P&wws[WW1].Ts,						US_INT, 1, P&hid1,	V0, 0, 0},
	{" 93;"," NACHSTELLZEIT  "," s     ", P&wws[WW1].Tn,						US_INT, 1, P&hid1,	V0, 0, 0},
	{" 94;"," WIEDERANLAUF   "," %     ", P&wws[WW1].VentStell,			US_INT, 1, P&hid1,	V0, 0, 0},
	{" 95;"," GRENZ-STELLUNG "," %     ", P&wws[WW1].VentGrenz,			US_INT, 1, P&hid1,	V0, 0, 0},
	{"*96;"," SOLLWERT       "," C    ", P&wwd[WW1].tsol,					US_INT, 1, P&hid1,	V1, 0, 0},
	{"*97;"," REGELABWEICHUNG"," K     ", P&wwd[WW1].ei,						 S_INT, 1, P&hid1,	V0, 0, 0},
	{"*->."," dy_rel         ","       ", P&wwd[WW1].dy_rel,				 S_INT, 3, P&hid2,	V0, 0, 0},
	{"*98;"," VENT.ST. RV TWE"," %     ", P&RVENTWW[WW1],				AOUT_FORMP, 1, P&hid1,	V1, 0, 0},
	{" 98;"," LADUNGEN KESSEL","       ", P&wwd[WW1].puwlsta, 			US_INT, 0, P&hid1,	V0, 0, 0},
	{" 98;"," LADEZEIT KESSEL"," h     ", P&wwd[WW1].puwlh,					US_INT, 0, P&hid1,	V0, 0, 0},

	{" 99;"," HAND/AUTOMATIK "," HAND=1", P&wws[WW1].Haut,				 US_CHAR, 0, P&hid1,	V1, 0, 0},
	{" ->;"," PU TWE     E/A "," EIN=1 ", P&wws[WW1].Tpea,				 US_CHAR, 0, P&hid1,	V1, 0, 0},
	{" ->;"," PU TWE REGELART"," 0..3  ", P&BusPuPara[PU_BUS_TPU_WW1-1].RegelartHand,	US_CHAR, 0, P&wilo4,	V1, 0, 0},
	{" ->;"," PU TWE SOLLWERT"," %     ", P&BusPuPara[PU_BUS_TPU_WW1-1].SollHand,	 		US_INT,  1, P&wilo4,	V1, 0, 0},

	{" ->;"," PU ZIR EIN/AUS "," EIN=1 ", P&wws[WW1].Zpea,				 US_CHAR, 0, P&hid1,	V1, 0, 0},
	{" ->;"," PU ZIR REGELART"," 0..3  ", P&BusPuPara[PU_BUS_ZPU_WW1-1].RegelartHand,	US_CHAR, 0, P&wilo5,	V1, 0, 0},
	{" ->;"," PU ZIR SOLLWERT"," %     ", P&BusPuPara[PU_BUS_ZPU_WW1-1].SollHand,	 		US_INT,  1, P&wilo5,	V1, 0, 0},

	{" ->;"," LADUNG EIN/AUS "," EIN=1 ", P&wws[WW1].Lpea,				 US_CHAR, 0, P&hid1,	V1, 0, 0},
	{" ->;"," STELLEN RV TWE "," % auf ", P&wws[WW1].Vstell,			  US_INT, 1, P&hid1,	V1, 0, 0},
};
#endif		// #if WWANZ > 0
...
#endif
#if ZE9==1
	#include "zin09_WZ2_Solar.h"
#endif
#if ZE10==1
	#include "zin10_WZ3_TWE.h"
#endif
...
const Pgrup zlt[] = {
 ...
 {" 08."," IrDA-S4        "," JA=1  ", P&IrDA_S4,											 US_CHAR, 0, P&hid2,	V0, 0, 0},
 {" 09."," MASTER-S4      "," JA=1  ", P&Mode_S4,											 US_CHAR, 0, P&hid2,	V0, 0, 0},
  
 {" 08;"," FERNBED  1=GBUS"," 0=XBUS", P&fb_bus,											 US_CHAR, 0, P&hid1,	V0, 0, 0},
 {" 09;"," FERNBED-ADRESSE","       ", P&fb_adresse,									 US_CHAR, 0, P&hid1,	V0, 0, 0},
 {" 10;"," FERNBEDIENUNG  "," JA=1  ", P&fernbedien,									 US_CHAR, 0, P&hid1,	V0, 0, 0},

 {"_11;"," OBJ-BEZEICHNUNG","       ", (char*)(OBJBEZ_ADR),		 EEP_ASCII_FORM, 15, P&hid1,	V0, 0, 0},
 {"_12;"," OBJ-NUMMER     ","       ", (char*)(OBJNUM_ADR),		 EEP_ASCII_FORM,  9, P&hid1,	V0, 0, 0},
 {"_13;"," STRASSE        ","       ", (char*)(STRASSE_ADR),	 EEP_ASCII_FORM, 15, P&hid1,	V0, 0, 0},
 {"_14;"," HAUSNUMMER     ","       ", (char*)(NUMMER_ADR),		 EEP_ASCII_FORM,  9, P&hid1,	V0, 0, 0},
 {"_15;"," ORT            ","       ", (char*)(ORT_ADR),		 	 EEP_ASCII_FORM, 15, P&hid1,	V0, 0, 0},
 {"_16;"," PLZ            ","       ", (char*)(PLZAHL_ADR),		 EEP_ASCII_FORM,  9, P&hid1,	V0, 0, 0},
 {"*17;"," OBJ-ORT FEHLT ?","       ", P&ort_idf,									 JANEIN_FORM, 0, P&hid1,	E1, ANZEIGE, 0},
...
const Pgrup tes[] = {
 ...
 {"*92:"," COMPILE   ZEIT ","       ", P&compile_time,							ASCII_FORM, 0, P&hid4,	V0, 0, 0},
 {"*93:"," COMPILE   DATUM","       ", P&compile_date,							ASCII_FORM, 0, P&hid4,	V0, 0, 0},
...
const Pgrup sys[] = {
 ...
 {"*01;"," PT1000_IN1     "," C    ", P&pt_mewe[0].messw,		ANA_FORM, 1, P&hid1,	V0, 0, 0},
 {" 01;"," PT1000_IN1 KORR"," Ohm   ", P&Pt_Korr[0],						 S_INT, 1, P&hid1,	V0, 0, 0},
 {" 01;"," PT1000_IN1 FILT"," 0-9   ", P&Pt_Filt[0],					 US_CHAR, 0, P&hid1,	V0, 0, 0},
 {" 01;"," In1 Fuehlertyp ","       ", P&Tp_Type[0],					 US_CHAR, 0, P&hid2,	V0, 0, 0},

 {"*02;"," PT1000_IN2     "," C    ", P&pt_mewe[1].messw,		ANA_FORM, 1, P&hid1,	V0, 0, 0},
 {" 02;"," PT1000_IN2 KORR"," Ohm   ", P&Pt_Korr[1],						 S_INT, 1, P&hid1,	V0, 0, 0},
 {" 02;"," PT1000_IN2 FILT"," 0-9   ", P&Pt_Filt[1],					 US_CHAR, 0, P&hid1,	V0, 0, 0},
 {" 02;"," In2 Fuehlertyp ","       ", P&Tp_Type[1],					 US_CHAR, 0, P&hid2,	V0, 0, 0},

 {"*03;"," PT1000_IN3     "," C    ", P&pt_mewe[2].messw,		ANA_FORM, 1, P&hid1,	V0, 0, 0},
 {" 03;"," PT1000_IN3 KORR"," Ohm   ", P&Pt_Korr[2],						 S_INT, 1, P&hid1,	V0, 0, 0},
 {" 03;"," PT1000_IN3 FILT"," 0-9   ", P&Pt_Filt[2],					 US_CHAR, 0, P&hid1,	V0, 0, 0},
 {" 03;"," In3 Fuehlertyp ","       ", P&Tp_Type[2],					 US_CHAR, 0, P&hid2,	V0, 0, 0},

 {"*04;"," PT1000_IN4     "," C    ", P&pt_mewe[3].messw,		ANA_FORM, 1, P&hid1,	V0, 0, 0},
 {" 04;"," PT1000_IN4 KORR"," Ohm   ", P&Pt_Korr[3],						 S_INT, 1, P&hid1,	V0, 0, 0},
 {" 04;"," PT1000_IN4 FILT"," 0-9   ", P&Pt_Filt[3],					 US_CHAR, 0, P&hid1,	V0, 0, 0},
 {" 04;"," In4 Fuehlertyp ","       ", P&Tp_Type[3],					 US_CHAR, 0, P&hid2,	V0, 0, 0},

 {"*05;"," PT1000_IN5     "," C    ", P&pt_mewe[4].messw,		ANA_FORM, 1, P&hid1,	V0, 0, 0},
 {" 05;"," PT1000_IN5 KORR"," Ohm   ", P&Pt_Korr[4],						 S_INT, 1, P&hid1,	V0, 0, 0},
 {" 05;"," PT1000_IN5 FILT"," 0-9   ", P&Pt_Filt[4],					 US_CHAR, 0, P&hid1,	V0, 0, 0},
 {" 05;"," In5 Fuehlertyp ","       ", P&Tp_Type[4],					 US_CHAR, 0, P&hid2,	V0, 0, 0},

 {"*06;"," PT1000_IN6     "," C    ", P&pt_mewe[5].messw,		ANA_FORM, 1, P&hid1,	V0, 0, 0},
 {" 06;"," PT1000_IN6 KORR"," Ohm   ", P&Pt_Korr[5],						 S_INT, 1, P&hid1,	V0, 0, 0},
 {" 06;"," PT1000_IN6 FILT"," 0-9   ", P&Pt_Filt[5],					 US_CHAR, 0, P&hid1,	V0, 0, 0},
 {" 06;"," In6 Fuehlertyp ","       ", P&Tp_Type[5],					 US_CHAR, 0, P&hid2,	V0, 0, 0},

 {"*07;"," PT1000_IN7     "," C    ", P&pt_mewe[6].messw,		ANA_FORM, 1, P&hid1,	V0, 0, 0},
 {" 07;"," PT1000_IN7 KORR"," Ohm   ", P&Pt_Korr[6],						 S_INT, 1, P&hid1,	V0, 0, 0},
 {" 07;"," PT1000_IN7 FILT"," 0-9   ", P&Pt_Filt[6],					 US_CHAR, 0, P&hid1,	V0, 0, 0},
 {" 07;"," In7 Fuehlertyp ","       ", P&Tp_Type[6],					 US_CHAR, 0, P&hid2,	V0, 0, 0},

 {"*08;"," PT1000_IN8     "," C    ", P&pt_mewe[7].messw,		ANA_FORM, 1, P&hid1,	V0, 0, 0},
 {" 08;"," PT1000_IN8 KORR"," Ohm   ", P&Pt_Korr[7],						 S_INT, 1, P&hid1,	V0, 0, 0},
 {" 08;"," PT1000_IN8 FILT"," 0-9   ", P&Pt_Filt[7],					 US_CHAR, 0, P&hid1,	V0, 0, 0},
 {" 08;"," In8 Fuehlertyp ","       ", P&Tp_Type[7],					 US_CHAR, 0, P&hid2,	V0, 0, 0},
 ...
 {"*38."," COUNTDOWN  BC  "," min   ", P&CountDwBc,						 US_CHAR, 0, P&hid2,	V0, 0, 0},
 ...
 {" 54;"," PROJ.EING R38_1","       ", P&mod38[0].inpUsed,					 DIGL_FORM,14, P&r38vis[0],	V0, 0, 0},
 ...
 {" 54;"," PROJ.EING R38_2","       ", P&mod38[1].inpUsed,					 DIGL_FORM,14, P&r38vis[1],	V0, 0, 0},
 ...
 {" 77."," Wartung setzen ","       ", P&sos[SO1].NotCode,			US_INT, 0, P&hid2,	V0},		// ***AnFre
 {"*78;"," WARTUNG IN     "," Tagen ", P&NotTage,								US_INT, 0, P&hid1,	V0},
 {"*79;"," WARTUNG ERFORD?","       ", P&NotBetr, 				 	JANEIN_FORM, 0, P&hid1,	V0},
 {"*->."," Notbetrieb-Temp","       ", P&sos[SO1].NotTemp, 			US_INT, 1, P&hid2,	V0},
 {"*->."," Notbetrieb Cnt ","       ", P&sos[SO1].zNotBetr, 		US_CHAR, 0, P&hid2,	V0},
...
#if ARCHIV_ANL == 1
 {"*85;"," ARCHIVIERUNG ? ","       ", P&archivAktiv,		 JANEIN_FORM, 0, P&hid1,		V0, 0, 0},
 {"*86;"," ANZAHL ARCH-DAE","       ", P&arch_par,				US_CHAR, 		0, P&hid1,	V0, 0, 0},
#endif
 ...
 {" ->;"," SDM-ARCHIV-INIT","       ", P&werks_sdm_code,		  US_INT,  2, P&hid1,	V0, 0, 0},
 ...
 {" ->;"," daily_init     ","       ", P&daily_init,			    US_CHAR, 0, P&hid2,	V0, 0, 0},
 {" ->;"," reset dae, exp "," -DAE,E", P&reset_dae,			    	  S_INT, 1, P&hid2,	V0, 0, 0},
#endif
...
#if ZE12==1
 {"KWZ:", x1ze1, sizeof(x1ze1) / PGLENG, P&x1ze_vis[0]},	// ***AnFre Kaltwasser-Zähler
#endif

#if ZE8WM == 1
 {"WHZ:", ze5, sizeof(ze5) / PGLENG, P&ze_vis[5]},	// ***AnFre Kessel
#endif

#if ZE9WM == 1
 {"WSK:", ze6, sizeof(ze6) / PGLENG, P&ze_vis[6]},	// ***AnFre Solar
#endif

#if ZE10WM == 1
 {"WTW:", ze7, sizeof(ze7) / PGLENG, P&ze_vis[7]},	// ***AnFre Netz
#else
	#if ZE10==1
...
#if ZE11==1
 {"ZAE:", x1ze0, sizeof(x1ze0) / PGLENG, P&x1ze_vis[0]},	// ***AnFre Externer Zähler Gas
#endif
...
//-	{"*08:"," DRUCK RUECKLAUF","       ", P&anaInp[U1].mwSkal, 	  ANA_FORM, 0x80, P&kom,	V1, 0 , 0},
...
//-	{" 09;"," druck rl ogw   "," bar   ", P&AnaInpPara[U1].OGW,	 		    S_INT, 2, P&hid2,	V0, 0 , 0},
...
//-	{"*10:"," sm druck ogw ? ","       ", P&anaInp[U1].ogwSM,			JANEIN_FORM, 0, P&hid2,	V0, 0 , 0},
