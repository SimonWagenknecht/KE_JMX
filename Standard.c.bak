...
// ***AnFre
	{EEPADR,	(char	*)&SomBegin,	SOMBEGIN_ADR,		2, 	0x0000},		// Datum: Sommer-Beginn
	{EEPADR,	(char	*)&SomEnd,		SOMEND_ADR,			2, 	0x0000},		// Datum: Sommer-Ende
	{EEPADR,	(char	*)&Klima,			KLIMA_ADR,			1, 	0},		// Klimaschutz ein/aus
	{EEPADR,	(char	*)&DTKlima,		DTKLIMA_ADR,		2, 	50},	// Absenkung bei Klimaschutz [K] * 10
...
// MBUS
...
#if TAE_ANZ == 1
	{EEPADR,	(char	*)&TaeSkalMin,				TA_IN_ADR,			2, 	 -400},	// -20,0 °C -> 0 Volt
	{EEPADR,	(char	*)&TaeSkalMax,				TA_IN_ADR + 2,	2, 	 	600},	// 40,0 °C -> 10 Volt
#endif

#if TAA_ANZ > 0
	{EEPADR,	(char	*)&TaaSkalMin,				TA_OUT_ADR,			2, 	 -400},	// -20,0 °C -> 0 Volt
	{EEPADR,	(char	*)&TaaSkalMax,				TA_OUT_ADR + 2,	2, 	 	600},	// 40,0 °C -> 10 Volt
#endif


#if ANFORD == 1
	{EEPADR,	(char	*)&TmanfSkalMin,			TMANF_ADR,			2, 			0},	// 0 °C
	{EEPADR,	(char	*)&TmanfSkalMax,			TMANF_ADR + 2,	2, 		900},	// 90,0 °C
	...
	{EEPADR,	(char	*)&TaErsatz[2],		TA_ERSATZ_ADR + 4,	2, 	   10},	// März 		 -0,0 °C
	...
	{EEPADR,	(char	*)&TaErsatz[10],	TA_ERSATZ_ADR + 20,	2, 	  -10},	// November 	0,0 °C
...
// ***AnFre: Anlage auf Notbetrieb schalten (in Alarme.c )
	{EEPADR,	(char	*)&NotBetr,				NOTBETR_ADR,		1}, 
	{EEPADR,	(char	*)&NotTage,				NOTTAGE_ADR,		2},  
...
/***** ulsch : Ferienprogramm*****/	
	...
	// ***AnFre 31.03.2010
	{	EEPADR,		(char *)&CO2_Faktor,											CO2_FAKTOR_ADR, 								sizeof(CO2_Faktor),									},
	{	EEPADR,		(char *)&Tyfocor,													TYFOCOR_ADR, 										sizeof(Tyfocor),										},
#endif
#if ZE10WM == 1
...
// ***AnFre: Kaltwasser-Volumenstrom KWZ mit Maximum 03.09.2009
	{ EEPADR,		(char	*)&volstrCtr,	KWZVOLMAX_ADR,	sizeof(volstrCtr) },
// ***AnFre: Kaltwasser-Volumenstrom KWZ Diagnose 03.09.2009
	{ EEPADR,		(char	*)&kws,	DIAG_PARA_ADR,	sizeof(kws) },
...
// ***AnFre Solare Heizkreise
#if HKSoLANZ > 0	
	// Solarer Regler
	{EEPADR,	(char	*)&hksSoL[SO1],				HKSoL1_ADR,				 HKSSoLLENG		}, // ***AnFre nur 1 Page
#endif
#if HKSoLANZ > 1	
	// Solarer Regler
	{EEPADR,	(char	*)&hksSoL[SO2],				HKSoL2_ADR,				 HKSSoLLENG		}, // ***AnFre nur 1 Page
#endif
...
//	{EEPADR,	(char	*)&ked[KE1].brestarts,BRESTARTS1_ADR+ 0,					2},	// ***AnFre 14.09.2011
//	{EEPADR,	(char	*)&ked[KE1].breh,			BREH1_ADR			+ 0,					2},
#endif
	...
	{EEPADR,	(char	*)&ked[KE2].kes2h,		KES2H1_ADR 		+ 2,					2},
#endif	
...
/* ------------------------ Warmwasser ---------------------------------*/
	...
	{EEPADR,	(char	*)&wwd[WW1].puwth,		PUWTH1_ADR		+ 0,					2},		// 30.05.2013
	{EEPADR,	(char	*)&wwd[WW1].puwzh,		PUWZH1_ADR		+ 0,					2},		// 30.05.2013
#endif
	...
	{EEPADR,	(char	*)&wwd[WW2].puwth,		PUWTH1_ADR		+ 2,					2},		// 30.05.2013
	{EEPADR,	(char	*)&wwd[WW2].puwzh,		PUWZH1_ADR		+ 2,					2},		// 30.05.2013
#endif
// ***AnFre
#if PRANZ > 0	
	/* Warmwasser-Sollwert Tages-Profil								*/
	{EEPADR,	(char	*)&prs[PR1],		PROFIL_ADR,			PRSLENG},	// 
#endif
